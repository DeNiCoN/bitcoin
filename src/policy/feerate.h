...
const std::string CURRENCY_UNIT = "SBTC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    SBTC_KVB,      //!< Use SBTC/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from SBTC/kvB to sat/vB.
     */
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::SBTC_KVB) const;
